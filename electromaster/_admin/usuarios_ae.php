          ...
          <div class="col-md-2"></div>
            <form action="usuarios.php" method="post" class="col-md-6 from-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox">
                        <label>
                        <?php if(isset($usuario->habilitado)) {
                                     if($usuario->habilitado == 1) {echo '<input type="checkbox" name="habilitado" value="0" "checked">';
                                    echo "Deshabilitar";
                                }else
                                    {echo '<input type="checkbox" name="habilitado" value="1">';
                                    echo "Habilitar";
                                }}  else {echo '<input type="hidden" name="habilitado" value="1" checked >' ;
                                            echo "Los usuarios nuevos, se habilitan por defecto.";} ?>
