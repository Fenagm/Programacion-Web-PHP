...
Class Usuario{
	...
	public function getList(){
		$query = "SELECT id_usuario,nombre,apellido,email,usuario,clave,habilitado 
		           FROM usuarios ";
		$resultado = array();
	...
	*/
	public function get($id){
	    $query = "SELECT id_usuario,nombre,apellido,email,usuario,clave,habilitado,salt,avatar
	...
	public function edit_user($data){
	    ...
	    unset($data['id_usuario']);
			...
			if(isset($_POST['avatar'])){
				$_SESSION['usuario']['avatar'] = $_POST['avatar']; 
			}
	...
	*/
        ...
        public function login($data){
            $sql = "SELECT id_usuario,nombre,apellido,email,usuario,clave,habilitado,salt,avatar
		           FROM usuarios WHERE habilitado = 1 AND usuario = '".$data['usuario']."'";
