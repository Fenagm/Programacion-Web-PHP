...
$coment = new Comentario($con);
    ...
    <div class="col-sm-9 col-md-10 main">
        ...
        <h2 class="sub-header">Listado
            ...
            <a href="comentarios_ae.php"><button type="button" class="btn btn-success" title="Agregar">A</button></a>
        </h2>
        <?php }?>

        
        <ul class="nav nav-tabs">
            <li class="active"><a href="#habilitados" data-toggle="tab">Habilitados</a></li>
            <li><a href="#deshabilitados" data-toggle="tab">Deshabilitados</a></li>
        </ul>
        <!-- Tab panes -->
        <div class="tab-content">
            <div class="tab-pane active" id="habilitados">
                <table id="tabla1" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <?php  	 
						    foreach($coment->getList('1') as $comentario){?>
                        ...
                        <tr>
                            ...
                            <td><?php echo substr($comentario['comentario'],0,30);?></td>
                            <!--<td><?php echo ($comentario['habilitado'] == 1)?'si':'no';?></td>-->
                            <td>
                                <?php if(in_array('coment.edit',$_SESSION['usuario']['permisos'])){?>
                                <a href="comentarios_ae.php?edit=<?php echo $comentario['id_ranking']?>"><button
                                        type="button" class="btn btn-info" title="Modificar">M</button></a>
                                <?php } ?>
                                <?php if(in_array('coment.del',$_SESSION['usuario']['permisos'])){?>
                                <a href="comentarios.php?del=<?php echo $comentario['id_ranking']?>"><button
                                        type="button" class="btn btn-danger" title="Borrar">X</button></a>
                                <?php } ?>
                            </td>
                            <?php } ?>
                        </tr>
            ...
            <div class="tab-pane" id="deshabilitados">
                <table id="tabla2" class="table table-striped">
                    ...
                    <?php  	 
                    foreach($coment->getList('0') as $comentario){?>
                    <tr>
                        <td><?php echo $comentario['id_ranking'];?></td>
                        <td><?php echo $comentario['valoracion'];?></td>
                        <td><?php echo $comentario['date'];?></td>
                        <td><?php echo $comentario['nombre'];?></td>
                        <td><?php echo $comentario['modelo'];?></td>
                        <td><?php echo substr($comentario['comentario'],0,20);?></td>
                        <!--<td><?php echo ($comentario['habilitado'] == 1)?'si':'no';?></td>-->
                        <td>
                            <?php if(in_array('coment.edit',$_SESSION['usuario']['permisos'])){?>
                            <a href="comentarios_ae.php?edit=<?php echo $comentario['id_ranking']?>"><button
